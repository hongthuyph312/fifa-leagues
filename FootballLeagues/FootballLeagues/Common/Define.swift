...
//MARK: Baby Index
let groupNameArray = ["Group A", "Group B", "Group C", "Group D", "Group E", "Group F", "Group G", "Group H"]

let groupA = ["Russia","Egypt","Saudi Arabia","Uruguay"]

let groupB = ["Iran","Morocco","Portugal","Spain"]

let groupC = ["Australia","Denmark","France","Peru"]
